...
pub async fn run_agent_loop(
    ...
    loop {
        ...
        let msg = tokio::select! {
            ...
            res = crate::llm::tool_execution::requests::chat_tools_once(client, model, messages.clone(), &runtime.tools, Some(cancel_token.clone())) => res?,
        };
        ...
        if !msg.tool_calls.is_empty() {
            ...
            for tc in msg.tool_calls {
                ...
                let res = tokio::select! {
                    biased;
                    _ = cancel_token.cancelled() => { warn!("run_agent_loop cancelled before dispatch_tool_call"); return Err(anyhow!(LlmErrorKind::Cancelled)); }
